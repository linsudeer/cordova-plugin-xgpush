...
SDK     | version
------- | --------------------------------
android | Xg-Push-SDK-Android-2.4.7
ios     | Xg-Push-SDK-iOS-2.5.0

## 声明

插件原作者 [链接](https://github.com/sunlu/cordova-plugin-xgpush)
此处引用原作者插件只是学习，更新，满足自己的需求用
...
```bash
cordova plugin add https://github.com/linsudeer/cordova-plugin-xgpush --save \
